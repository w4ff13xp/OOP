...
public class NewVendorAssessment {
    ...
    // Constructors
    public NewVendorAssessment() {
    }


    public NewVendorAssessment(String companyName, Long registrationNo, String officeAddress, boolean getRegistered,
