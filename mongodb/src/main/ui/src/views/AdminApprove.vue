    ...
    <div>
      <table class="table table-hover table-bordered table-striped text-center">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="2">Additional Comments: {{ comments }}</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  methods: {
    ...
    async getInputs() {
      try {
        ...
        console.log(formid);
        await axios
          .get(`http://localhost:8080/healthEvaluation/${formid}`)
          .then((response) => {
            ...
            this.safetyCoordinatorEvaluationDate =
              data.safetyCoordinatorEvaluationDate;
    ...
    changeApproveStatus() {
      if (
        ...
        axios
          .put(`http://localhost:8080/healthEvaluation/updateStatus`, toUpdate)
          .then((response) => {
